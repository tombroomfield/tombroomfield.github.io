...
Alas, I began to start implementing the rules in my code, and very quickly I began to realise what Sandi may have been getting at.
...
Wrapping up, the 100 line rule is a lot less about the length of your files and a lot more about ensuring you are using proper OOP techniques to distribute responsibilities to classes that only care about one thing.
